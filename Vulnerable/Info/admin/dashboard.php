...
$post_ids = []; // Initialize as empty array
$likes = [];
$user_likes = [];

// Only execute the post likes code if we have post IDs (for future use)
if (isset($post_ids) && !empty($post_ids)) {
    ...
    // Get user likes - fixed the undefined $doctor_id variable
